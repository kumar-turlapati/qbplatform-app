...
export const SearchBlackIcon = props => (
  <IconBase
    {...props}
    source={require('./searchBlackIcon.png')}
    resizeMode={'contain'}
  />
);
...
export const ArrowLeft = props => (
  <IconBase
    {...props}
    source={require('./ic_arrow_left.png')}
    resizeMode={'contain'}
  />
);
