  ...
  const renderCustomerName = () => {
    return (
      <View style={{ backgroundColor: 'white' }}>
        <View style={{
          marginLeft: 16, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', borderBottomColor: 'rgba(0,0,0,0.1)',
          borderBottomWidth: 1,
        }}>
          <Text style={styles.titleStyle}>Customer</Text>
          <Text style={[styles.titleStyle, { marginRight: 40, opacity: 1 }]}>{name}</Text>
        </View>
        <View style={styles.listViewStyle}>
          ...
          <SideArrow style={{ width: 9, height: 16, top: 22, right: 20, position: 'absolute' }} resizeMode={'contain'} />
        </View>
      </View >
    );
  }
      ...
      <View style={{ backgroundColor: 'white', marginTop: 32 }}>
        ...
        <View style={styles.listViewStyle}>
          <View>
            ...
            <Text style={[styles.descriptionStyle, { paddingBottom: 0 }]}>05-06-2020, 18:00</Text>
            <Text style={styles.descriptionStyle}>Order diparched to warehouses</Text>
          </View>
          <Text style={[styles.statusTextStyle, { backgroundColor: '#34C759' }]}>{'Completed'}</Text>
        </View>
        <View style={styles.listViewStyle}>
          <View>
            ...
            <Text style={[styles.descriptionStyle, { paddingBottom: 0 }]}>05-06-2020, 18:00</Text>
            <Text style={styles.descriptionStyle}>Your order No. 575757 with Invoice
            No. xxxxxxxx has been dispatched successfully
            through GTM Carriers, Hyderabad vide transport
            receipt no. xxxxxxxx. Track your order with Carrier. </Text>
          </View>
          <Text style={[styles.statusTextStyle, { backgroundColor: '#F2994A', position: 'absolute', right: 0 }]}>{'In progress'}</Text>
        </View>
      </View>
    );
  }
