    ...
    return (
      <View style={{ backgroundColor: 'white', marginTop: 17 }}>
        ...
        <View style={styles.viewStyle}>
          ...
          <Text style={[styles.titleStyle, { marginRight: 40, opacity: 1 }]}>{invoiceNumber}</Text>
        </View>
        <View style={styles.viewStyle}>
    ...
    return (
      <View style={{ backgroundColor: 'white', marginTop: 17 }}>
        ...
        <View style={styles.viewStyle}>
          ...
          <Text style={[styles.titleStyle, { marginRight: 40, opacity: 1 }]}>2.5</Text>
        </View>
        <View style={styles.viewStyle}>
          <Text style={styles.titleStyle}>Amount</Text>
          <Text style={[styles.titleStyle, { marginRight: 40, opacity: 1 }]}>₹ 500</Text>
        </View>
      </View>
    );
  }
