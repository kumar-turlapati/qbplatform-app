...
export const OrderUpdate = ({ navigation }) => {
      ...
      <View style={{ backgroundColor: 'white', marginTop: 17 }}>
        ...
        <TouchableOpacity activeOpacity={1} onPress={() => {
          ...
          <View style={[styles.viewStyle, { height: 48 }]}>
            <Text style={styles.titleStyle}>Billing Type</Text>
            <Text style={[styles.titleStyle, { marginRight: 40, opacity: 1 }]}>Wholesale</Text>
            <SideArrow style={{ width: 9, height: 16, top: 16, right: 19, position: 'absolute' }} resizeMode={'contain'} />
          </View>
        </TouchableOpacity>
        <View style={styles.viewStyle}>
          <Text style={styles.titleStyle}>Rate</Text>
          <Text style={[styles.titleStyle, { marginRight: 40, opacity: 1 }]}>1456 Rs</Text>
        </View>
      </View>
    );
  }
