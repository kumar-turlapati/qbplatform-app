      ...
      <View style={{ backgroundColor: 'white', marginTop: 17 }}>
        <TouchableOpacity activeOpacity={1} onPress={() => {
          ...
          <View style={[styles.viewStyle, { height: 48 }]}>
            ...
            <SideArrow style={{ width: 9, height: 16, top: 14, right: 19, position: 'absolute' }} resizeMode={'contain'} />
          </View>
        </TouchableOpacity>

        <View style={styles.viewStyle}>
          <Text style={styles.titleStyle}>Order ID</Text>
          <Text style={[styles.titleStyle, { marginRight: 40, opacity: 1 }]}>23456789</Text>
        </View>
      </View >
    );
  }
    ...
    return (
      <View style={{ backgroundColor: 'white', marginTop: 17 }}>
        ...
        <View style={styles.viewStyle}>
          ...
          <Text style={[styles.titleStyle, { marginRight: 40, opacity: 1 }]}>10</Text>
        </View>
        <View style={styles.viewStyle}>
          <Text style={styles.titleStyle}>Rate</Text>
          <Text style={[styles.titleStyle, { marginRight: 40, opacity: 1 }]}>100 Rs</Text>
        </View>
        <View style={styles.viewStyle}>
          <Text style={styles.titleStyle}>Amount</Text>
          <Text style={[styles.titleStyle, { marginRight: 40, opacity: 1 }]}>1000 Rs</Text>
        </View>
        <View style={styles.viewStyle}>
          <Text style={styles.titleStyle}>Dispatched Qty</Text>
          <Text style={[styles.titleStyle, { marginRight: 40, opacity: 1, color: '#34C759' }]}>5</Text>
        </View>
        <View style={styles.viewStyle}>
          <Text style={styles.titleStyle}>Pending Qty</Text>
          <Text style={[styles.titleStyle, { marginRight: 40, opacity: 1, color: '#FF3B30' }]}>5</Text>
        </View>
      </View>
    );
  }
