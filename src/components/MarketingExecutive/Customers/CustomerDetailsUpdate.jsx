        ...
        <View style={styles.viewStyles}>
          ...
          <Text
            style={[
              ...
              {marginRight: 48, opacity: 1, color: '#0081CE'},
            ]}>
            Hyderabad
          </Text>
          <SideArrow
        ...
        <View style={styles.viewStyles}>
          <View>
            <Text
              style={[
                styles.titleStyle,
                {paddingBottom: 0, opacity: 1, color: 'black'},
              ]}>
              Address
            </Text>
            <Text
    ...
    return (
      <View style={{backgroundColor: 'white', marginTop: 36}}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            navigation.navigate(
              ScreenNamesMarketing.CUSTOMERAPPOINTMENTANDORDER,
              {name: name},
            );
          }}>
          <View style={[styles.viewStyles, {height: 40}]}>
